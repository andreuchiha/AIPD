...
This module implements the training pipeline for a Logistic Regression classifier
...
from feature_engineering import build_tfidf_vectorizer, vectorize_with_extras_batch, vectorize_train_test
...
def train_and_evaluate_lr(
    ...
    vec_path = os.path.join(model_output_dir, 'tfidf_vectorizer_lr.pkl')
    model_path = os.path.join(model_output_dir, 'phish_detector_lr.pkl')
    selector_path = os.path.join(model_output_dir, 'feature_selector_lr.pkl')
    features_path = os.path.join(model_output_dir, 'selected_features_lr.pkl')
...
if __name__ == "__main__":
    ...
    train_and_evaluate_lr(data_csv) 